...
//
  ...
  <img src={Logo} className="w-32 h-20 sm:w-32 sm:h-20 object-contain sm:object-fill" alt="" />
</div>
      ...
      <nav className="hidden md:flex space-x-4">
        ...
        <a href="/contact" className="flex flex-col items-center text-gray-700 hover:text-[#0fb8ce] transition text-sm">
        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <div className="absolute top-8 left-0 bg-white border shadow-lg rounded-md z-40">
              <ul className="py-1">
                <li><a href="/" className="block px-4 py-1 hover:bg-blue-100 text-sm">Web Development</a></li>
                <li><a href="/" className="block px-4 py-1 hover:bg-blue-100 text-sm">Digital Marketing</a></li>
                <li><a href="/" className="block px-4 py-1 hover:bg-blue-100 text-sm">Ecommerce</a></li>
                <li><a href="/" className="block px-4 py-1 hover:bg-blue-100 text-sm">Creatives</a></li>
                <li><a href="/" className="block px-4 py-1 hover:bg-blue-100 text-sm">Quality Assurance</a></li>
              </ul>
            </div>
          )}
        </div>
